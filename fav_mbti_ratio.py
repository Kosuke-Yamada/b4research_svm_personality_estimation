...
#READ_FEE_FILE = "../DATA/19.16P_RT_FAV_USER_MBTI/new_16p_user_fav_"+str(int(P*100)).zfill(3)+"_"+str(MIN_FAV).zfill(2)+".json"### 
READ_FEE_FILE = "../DATA/19.16P_RT_FAV_USER_MBTI/16p_user_fav_"+str(int(P*100)).zfill(3)+"_"+str(MIN_FAV).zfill(2)+"_"+str(MIN_TWEET)+".json"

#書き込みディレクトリ, ファイル
WRITE_DIR = "../DATA/09.DATASET_ALL/"###
if os.path.exists(WRITE_DIR) == False:
    os.mkdir(WRITE_DIR)
#WRITE_FILE = WRITE_DIR+"new_fav_mbti_ratio_"+str(int(P*100)).zfill(3)+"_"+str(MIN_FAV).zfill(2)+"_"+str(MIN_TWEET).zfill(4)+".json"###
WRITE_FILE = WRITE_DIR+"fav_mbti_ratio_"+str(int(P*100)).zfill(3)+"_"+str(MIN_FAV).zfill(2)+"_"+str(MIN_TWEET).zfill(4)+".json"###                         
